...
class Solution:
    def maxArea(self, height) -> int:
        ...
        MIN_ON_LEFT_RES, MEMO, MIN_ON_RIGHT_RES, POUR_WATER_RES, ENDS_RES  = [method(height) for method in [min_on_left, min_on_left_memoized, min_on_right, pour_water, ends_first]]
